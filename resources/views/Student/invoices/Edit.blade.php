    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                <div class="col-xs-12">
                    <form action="{{ route('invoices.update', $feeInv->id) }}" method="POST">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="custom-select my-1 mr-sm-2" name="type" id="gard_id">
                                    <option value="{{ $feeInv->type }}" selected>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name='mount' value='{{ $feeInv->amount }}'
                                    id="salary_mount">
                            </div>
                        </div>
