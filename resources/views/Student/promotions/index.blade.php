                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class='alert-danger'>{{ trans('site.old_gard') }}</th>
                                <th class='alert-danger'>{{ trans('site.old_class') }}</th>
                                <th class='alert-danger'>{{ trans('site.old_section') }}</th>

                                <th class='alert-success'>{{ trans('site.gard') }}</th>
                                <th class='alert-success'>{{ trans('site.classroom') }}</th>
                                <th class='alert-success'>{{ trans('site.section') }}</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($promo as $Student)
                                <tr>
                                    ...
                                    <td>{{ $Student->Ol_Gard->name }}</td>
                                    <td>{{ $Student->Ol_Class->name }}</td>
                                    <td>{{ $Student->Ol_Section->name }}</td>

                                    <td>
                                        <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal"
                                            data-target="#delete_Student{{ $Student->id }}"
                                            title="{{ trans('site.Delete') }}"><i class="fa fa-trash"></i></button>

                                        <a href="{{ route('RestPromotionsOne', $Student->id) }}"
